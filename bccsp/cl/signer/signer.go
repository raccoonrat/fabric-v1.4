...
func New(csp bccsp.BCCSP, key bccsp.Key) (crypto.Signer, error) {
	...
	return &clCryptoSigner{csp, key, pk}, nil
}

// Public returns the public key corresponding to the opaque,
// private key.
func (s *clCryptoSigner) Public() crypto.PublicKey {
	return s.pk
}
...
func (s *clCryptoSigner) Sign(rand io.Reader, digest []byte, opts crypto.SignerOpts) ([]byte, error) {
